        ...
        (
          <div>
            <ul className="nav navbar-nav navbar-left">
              ...
              <li><MenuItem onClick={this.handleClose}><Link className="navBarText" to="/trip/create">Create Trip</Link></MenuItem></li>
      ...
      <div className="bar">
        ...
        <div className="hamburgerContainer col-xs-3 col-xs-offset-9">
          ...
          >
            ...
            {loggedIn ?
              <div>
                <Link className="navText" to="/trip/create"><MenuItem onClick={this.handleClose}><i className="material-icons">&#xE55E;</i>Create Trip</MenuItem></Link>
            ...
            {loggedIn ? null : <div>
              ...
              <Link className="navText"><MenuItem onClick={this.handleClose}><i className="material-icons">&#xE14F;</i>Sign Up</MenuItem></Link>
            </div>}
          </Drawer>
        </div>
      </div>
